...
/** Why AI-assisted modernization — Faster Application Discovery (TMS-86). */
...
/** Why AI-assisted modernization — Improved Quality (TMS-86). */
...
/** Why AI-assisted modernization — Reduced Risk (TMS-86). Plain shield outline — distinct from
 * `ShieldCheckIcon`, which adds an inner checkmark this reference's icon does not have. */
...
/** Why AI-assisted modernization — Enterprise-Grade Delivery (TMS-86). */
...
/** Industries we modernize — FinTech (TMS-86). Plain bank/rect shape — distinct from
 * `NavFinTechIcon`/`IndustryFinTechIcon`, which both add a third small bottom line this
 * reference's icon does not have. */
export function FinTechBankIcon(props: IconProps) {
  return (
    <svg
      width="20"
      height="20"
