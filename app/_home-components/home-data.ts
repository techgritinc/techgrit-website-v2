...
export const DIFFERENTIATORS: DifferentiatorPoint[] = [
  {
    ...
    description:
      "We don't just use AI to suggest code. We deploy agents to own entire domains of the software lifecycle.",
    tone: "orange",
  },
  {
    ...
    description:
      "Code generated by OrbitAI™ is uniformly structured, fully documented, and instantly refactorable.",
    tone: "blue",
  },
  {
    icon: InfiniteScalabilityIcon,
    title: "Infinite Scalability",
    description: "Architecture that adapts and scales automatically based on predictive AI models.",
    tone: "teal",
  },
];
