...
export const DELIVERY_STATS: DeliveryStat[] = [
  { value: "10X", label: "Delivery Speed" },
  { value: "6 weeks", label: "Sprint to Scale" },
  { value: "zero", label: "Legacy Debt" },
];

export type TrustedClientLogo = { src: string | null; alt: string };

export const TRUSTED_CLIENT_LOGOS: TrustedClientLogo[] = [
  { src: "/logos/client-evolve.png", alt: "Evolve" },
  { src: "/logos/client-sunnyday.png", alt: "Sunny Day Fund" },
  { src: "/logos/client-bcbs.png", alt: "BlueCross BlueShield" },
  { src: "/logos/client-aqua.png", alt: "AquA Finance" },
  { src: "/logos/client-commsai.png", alt: "CommsAI" },
  { src: "/logos/client-turnqey.png", alt: "Turnqey" },
];
...
export type PlatformCapability = { icon: IconComponent; title: string; description: string };
...
export type DifferentiatorPoint = { icon: IconComponent; title: string; description: string };
