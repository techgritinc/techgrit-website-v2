...
// right-button panel shape byte-for-byte — this route's detail page is still static, same as
// that one, so it follows the same precedent rather than the centered components/ui/final-cta.tsx.
export function JobDetailFinalCta({
  title,
  titleHighlight,
  description,
  ctaLabel,
