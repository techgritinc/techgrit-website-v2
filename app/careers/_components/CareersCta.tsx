  ...
  return (
    <section className="relative">
      <div className="mx-auto max-w-[1280px] px-9 pt-[30px] pb-[90px]">
        <div className="relative flex flex-wrap items-center justify-between gap-7.5 overflow-hidden rounded-3xl border border-border-faint bg-ink-mid px-12 py-13.5">
          <div
            aria-hidden="true"
          ...
          <div className="relative max-w-[620px]">
            ...
            <p className="mt-3.5 text-[16.5px] leading-[1.6] tracking-[0] text-text-70">{content.copy}</p>
          </div>
