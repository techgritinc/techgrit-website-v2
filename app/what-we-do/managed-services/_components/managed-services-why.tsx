...
export function ManagedServicesWhy({ section }: { section: WhySection }) {
  return (
      ...
      <div className="mx-auto max-w-[1280px] px-9 py-[60px]">
        <RevealOnScroll>
          <div className="mb-10 text-center">
            ...
            {section.statement && (
              <p className="mx-auto mt-3.5 max-w-[640px] text-[17px] leading-[1.6] text-text-66">{section.statement}</p>
            )}
          </div>
