...
export function ManagedServicesCapabilities({ section }: { section: CapabilitiesSection }) {
  return (
          ...
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
            {section.capabilities.map((capability) => (
              <GlassCard key={capability.id} variant="serviceCapability">
                ...
                <GlassCardTitle variant="serviceCapability">{capability.title ?? capability.stepLabel}</GlassCardTitle>
